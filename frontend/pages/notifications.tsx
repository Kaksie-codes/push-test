...
interface Notification {
  _id: string;
  type: 'follow' | 'new_post' | 'comment' | 'reply' | 'like';
  message: string;
  isRead: boolean;
  createdAt: string;
  readAt?: string;
...
export default function NotificationsPage() {
  ...
  const handleNotificationClick = (notification: Notification) => {
    ...
    if (notification.type === 'follow') {
      ...
      router.push(`/posts/${notification.entityId._id}`);
    } else if (notification.type === 'comment' && notification.entityId) {
      // Navigate to the post where the comment was made
      router.push(`/posts/${notification.entityId._id}`);
    } else if (notification.type === 'reply' && notification.entityId) {
      // Navigate to the post where the reply was made
      router.push(`/posts/${notification.entityId._id}`);
    } else if (notification.type === 'like' && notification.entityId) {
